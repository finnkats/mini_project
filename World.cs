public static class World
{
    ...
    public const int QUESTS_AMOUNT_FOR_COMPLETION = 3;
    ...
    public static void PopulateLocations()
    {
        ...
        if (alchemistHut.QuestAvailableHere != null) alchemistHut.QuestAvailableHere.MonsterRequiredForCompletion = MONSTER_ID_RAT;
        ...
        if (farmhouse.QuestAvailableHere != null) farmhouse.QuestAvailableHere.MonsterRequiredForCompletion = MONSTER_ID_SNAKE;
        ...
        if (bridge.QuestAvailableHere != null)  bridge.QuestAvailableHere.MonsterRequiredForCompletion = MONSTER_ID_GIANT_SPIDER;
